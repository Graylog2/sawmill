...
export declare const generateFontSizes: (rootFontSize: number, scale: number, sizePowers: TSizePowers) => TFontSizes;
declare const _default: {
    generateFontSizes: (rootFontSize: number, scale: number, sizePowers: TSizePowers) => {
