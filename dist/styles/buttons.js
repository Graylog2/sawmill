...
var buttons = function (_a) {
    ...
    return Object.keys(variants).map(function (variant) {
        ...
        var defaultBorder = isLink ? variants.link : mixColor(variantColor, buttonAdjustColor, 0.05);
        var defaultColor = isLink ? colors.global.link : utils.contrastingColor(defaultBackground);
        var activeBackground = isLink ? variants.link : mixColor(variantColor, buttonAdjustColor, 0.10);
        var activeBorder = isLink ? variants.link : mixColor(variantColor, buttonAdjustColor, 0.15);
        var activeColor = isLink ? colors.global.linkHover : utils.contrastingColor(activeBackground);
        var disabledBackground = isLink ? variants.link : mixColor(variantColor, buttonAdjustColor, 0.20);
        var disabledBorder = isLink ? variants.link : mixColor(variantColor, buttonAdjustColor, 0.15);
        ...
        var hoverColor = isLink ? colors.global.linkHover : mixColor(defaultColor);
        ...
        var activeHoverColor = isLink ? colors.global.linkHover : mixColor(activeColor);
        return styled_components_1.css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      &.btn-", " {\n        background-color: ", ";\n        border-color: ", ";\n        color: ", ";\n        transition: background-color 150ms ease-in-out,\n          border 150ms ease-in-out,\n          color 150ms ease-in-out;\n\n        :hover {\n          background-color: ", ";\n          border-color: ", ";\n          color: ", ";\n        }\n\n        &.active {\n          background-color: ", ";\n          border-color: ", ";\n          color: ", ";\n\n          :hover {\n            background-color: ", ";\n            border-color: ", ";\n            color: ", ";\n          }\n        }\n\n        &[disabled],\n        &.disabled {\n          background-color: ", ";\n          border-color: ", ";\n          color: ", ";\n\n          :hover {\n            background-color: ", ";\n            border-color: ", ";\n            color: ", ";\n          }\n        }\n      }\n    "], ["\n      &.btn-", " {\n        background-color: ", ";\n        border-color: ", ";\n        color: ", ";\n        transition: background-color 150ms ease-in-out,\n          border 150ms ease-in-out,\n          color 150ms ease-in-out;\n\n        :hover {\n          background-color: ", ";\n          border-color: ", ";\n          color: ", ";\n        }\n\n        &.active {\n          background-color: ", ";\n          border-color: ", ";\n          color: ", ";\n\n          :hover {\n            background-color: ", ";\n            border-color: ", ";\n            color: ", ";\n          }\n        }\n\n        &[disabled],\n        &.disabled {\n          background-color: ", ";\n          border-color: ", ";\n          color: ", ";\n\n          :hover {\n            background-color: ", ";\n            border-color: ", ";\n            color: ", ";\n          }\n        }\n      }\n    "])), variant, defaultBackground, defaultBorder, defaultColor, hoverBackground, hoverBorderColor, hoverColor, activeBackground, activeBorder, activeColor, isLink ? variants.link : activeHoverBackground, activeHoverBorderColor, activeHoverColor, isLink ? variants.link : disabledBackground, disabledBorder, disabledColor, disabledBackground, disabledBorder, disabledColor);
    });
};
